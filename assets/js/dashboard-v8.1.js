(() => {
  ...
  const TREND_FALLBACKS = {
    vc: {
      ...
      data: [8417, 11033, 11970, 16770, 11058, 8844, 10695, 11889],
      unit: '억 원',
      note: '국내 바이오·의료 VC 신규투자'
    },
    patent: {
      labels: ['2016', '2017', '2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'],
      data: [2323, 3102, 2869, 2946, 3264, 3121, 2200, 2523, 2342, 3026],
      unit: '건',
      note: '국내 바이오 등록특허'
    }
  };
  ...
  function createTrendDashboard() {
    ...
    trendDefinitions.forEach((definition, index) => {
      const series = data[definition.key] || TREND_FALLBACKS[definition.key];
      if (!series) {
        console.warn(`[HsLab] Trend data missing: ${definition.key}`);
        return;
      }
